      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <a target='_blank' href='https://github.com/amjadelhassan'><b className="purple"> github</b></a>! find my latest art pieces on <a href="https://instagram.com/bloopysoup"><b className="purple"> instagram</b></a> or read my latest <a href="https://codemonkeycove.com"><b className="purple"> web development articles/tutorials!</b></a> Have fun exploring and thanks for stopping by!
